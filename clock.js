function clock()
{
    ...
    {
        case 0: day="Sunday"
            document.body.style.backgroundImage="url(./chitralahari.jpg)";
            break;
        case 1: day="Monday"
            document.body.style.backgroundImage="url(./feed.jpg)";
            break;
        case 2:day="Tuesday"
            document.body.style.backgroundImage="url(./home.jpg)";
            break;
        case 3:day="Wednesday"
            document.body.style.backgroundImage="url(./KGF.jpg)";
            break;
        case 4:day="Thusday"
            document.body.style.backgroundImage="url(./info.jpg)";
            break;
        case 5:day="Friday"
            document.body.style.backgroundImage="url(./pushpa.jpg)";
            break;
        case 6:day="saterday"
            document.body.style.backgroundImage="url(./Soorarai Pottru.jpg)";
    }
    console.log(day);
